    ...
    return (
        ...
        <div className="lg:m-12 lg:ml-16 lg:mr-12 m-4 flex flex-col lg:justify-center lg:items-center  p-8">
            ...
            <p className="text-lg lg:text-2xl mb-8 lg:text-center text-justify">
                অভিনন্দন জানাই আপনাকে সেশনটি থেকে সর্বোচ্চ সুবিধা নেওয়ার জন্য নিরিবিলি বসে মনোযোগ সহকারে দেখুন ও হাতের কাছে কাগজ-কলম রাখুন।
                আজকের এই সেশনটিতে জীবন পরিবর্তনকারী কিছু মেসেজ ও গাইডলাইন পাবেন, যা হাজারো মানুষের মতো আপনার ক্যারিয়ার বা জীবনেও কাজে লাগবে বলে বিশ্বাস করি।
                সেশন শুরু হতে যদি কিছুটা সময় বাকি থাকে তবে এই পেজের নিচের দিকে ভিজিট করে আমার বা আমার কার্য্যক্রম সম্পর্কে আরো কিছুটা বিস্তারিত জেনে নিতে পারেন।
                আশা করছি আজকের সেশন থেকে নতুন কিছু জানতে পারবেন যা কাজে লাগিয়ে আপনার ক্যারিয়ার, আপনার রেভিনিউ ও আপনার ব্যবসায়ীক সফলতাকে একধাপ এগিয়ে নিতে সক্ষম হবেন ইনশাআল্লাহ।
            </p>
