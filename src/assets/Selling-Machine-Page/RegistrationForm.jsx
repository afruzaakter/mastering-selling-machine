    ...
    <>
      ...
      <div className="card bg-base-100  lg:w-96  shadow-xl">
        <div className="card-body lg:items-center lg:text-center">
          <h2 className="lg:text-3xl text-2xl font-bold text-gray-600 ">
            Join our Free Webinar
          </h2>
          <p className=" [font-size:18px] lg:mr-10 lg:ml-10">
            Join our free webinar to learn how to get the best out of your
          ...
          <div className="card-actions">
            <p className="[font-size:16px] mt-4">
              ওয়েবিনারটি কিছুক্ষনের মধ্যেই শুরু হতে যাচ্ছে, অংশগ্রহন করার জন্য
              এখনই ১০০% ফ্রি রেজিস্ট্রেশন সম্পন্ন করুন।
            </p>
          </div>
        </div>
      </div>
